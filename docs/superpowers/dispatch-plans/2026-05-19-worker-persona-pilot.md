...
- Working Brief Reference: `docs/superpowers/working-briefs/2026-05-19-worker-persona-pilot-v1.md`
...
- Scope Declarations:
  - `exclusive_write_scope`:
    - `path_glob`: `docs/superpowers/working-briefs/2026-05-19-worker-persona-pilot-v1.md`
    - `path_glob`: `docs/superpowers/dispatch-plans/2026-05-19-worker-persona-pilot.md`
