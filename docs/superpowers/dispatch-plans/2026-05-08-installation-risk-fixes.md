...
- Working Brief Reference: `docs/superpowers/working-briefs/2026-05-08-installation-risk-fixes-v1.md`
...
- Scope Declarations:
  - `exclusive_write_scope`:
    ...
    - `path_glob`: `docs/superpowers/working-briefs/2026-05-08-installation-risk-fixes-v1.md`
    - `path_glob`: `docs/superpowers/dispatch-plans/2026-05-08-installation-risk-fixes.md`
  - `shared_read_scope`:
...
- Review Lane Records:
  ...
  - Attempt ID:
  - Review Target Ref:
    - Artifact Path: `docs/superpowers/dispatch-plans/2026-05-08-installation-risk-fixes.md`
    - Artifact Kind: `plan`
    - Artifact Revision: 1
    - Schema Version: 1
    - Section Anchor:
