...
- Working Brief Reference: `docs/legacy/superpowers/working-briefs/2026-05-07-ww-numbered-approval-v1.md`
...
- Planned Scope:
  ...
  - `docs/legacy/superpowers/working-briefs/2026-05-07-ww-numbered-approval-v1.md`
...
- Scope Declarations:
  - `exclusive_write_scope`:
    ...
    - `path_glob`: `docs/legacy/superpowers/working-briefs/2026-05-07-ww-numbered-approval-v1.md`
    - `path_glob`: `docs/legacy/superpowers/dispatch-plans/2026-05-07-ww-numbered-approval-design.md`
  - `shared_read_scope`:
