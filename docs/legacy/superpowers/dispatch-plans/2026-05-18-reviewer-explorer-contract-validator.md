...
- Working Brief Reference: `docs/legacy/superpowers/working-briefs/2026-05-18-reviewer-explorer-contract-validator-v1.md`
...
- Scope Declarations:
  - `exclusive_write_scope`:
    - `path_glob`: `docs/legacy/superpowers/specs/2026-05-18-reviewer-explorer-contract-validator-design.md`
    - `path_glob`: `docs/legacy/superpowers/plans/2026-05-18-reviewer-explorer-contract-validator.md`
    - `path_glob`: `docs/legacy/superpowers/working-briefs/2026-05-18-reviewer-explorer-contract-validator-v1.md`
    - `path_glob`: `docs/legacy/superpowers/dispatch-plans/2026-05-18-reviewer-explorer-contract-validator.md`
  ...
  - `artifact_mappings`:
    ...
    - `artifact_kind`: `doc`
    - `artifact_path`: `docs/legacy/superpowers/specs/2026-05-18-reviewer-explorer-contract-validator-design.md`
    - `section_anchors`: `Reviewer Contract Rules`, `Explorer Contract Rules`, `Alignment Rules`
    - `artifact_id`: `role_contract_impl_plan`
    - `artifact_kind`: `doc`
    - `artifact_path`: `docs/legacy/superpowers/plans/2026-05-18-reviewer-explorer-contract-validator.md`
