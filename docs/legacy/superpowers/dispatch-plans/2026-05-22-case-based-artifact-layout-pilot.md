...
- Working Brief Reference: `docs/legacy/superpowers/working-briefs/2026-05-22-case-based-artifact-layout-pilot-v1.md`
...
- Planned Scope:
  - `docs/legacy/superpowers/specs/2026-05-22-case-based-artifact-layout-design.md`
  - `docs/legacy/superpowers/plans/2026-05-22-case-based-artifact-layout.md`
...
- Scope Declarations:
  - `exclusive_write_scope`:
    - `path_glob`: `docs/legacy/superpowers/working-briefs/2026-05-22-case-based-artifact-layout-pilot-v1.md`
    - `path_glob`: `docs/legacy/superpowers/dispatch-plans/2026-05-22-case-based-artifact-layout-pilot.md`
...
- Attempt Records:
  ...
  - Result Artifact Location: `docs/legacy/superpowers/specs/2026-05-22-case-based-artifact-layout-design.md`, `docs/legacy/superpowers/plans/2026-05-22-case-based-artifact-layout.md`
- Attempt Count: 1
...
- Review Lane Records:
  ...
  - Attempt ID: attempt-case-layout-design-1
  - Review Target Ref:
    - Artifact Path: `docs/legacy/superpowers/specs/2026-05-22-case-based-artifact-layout-design.md`
    - Artifact Kind: doc
